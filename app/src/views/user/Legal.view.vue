<template>
  ...
  <v-container>
    ...
    <p>Alle Inhalte auf unserer Website sind unser Eigentum oder das von Dritten, mit denen wir zusammenarbeiten. Inhalte, die von Nutzern erstellt werden, unterliegen bestimmten Regeln, die in unseren Nutzungsbedingungen festgelegt sind.</p>
    <p>Unsere Haftung für die Nutzung unserer Website ist auf Vorsatz und grobe Fahrlässigkeit beschränkt.</p>
    <p>Wir behalten uns das Recht vor, diesen rechtlichen Hinweis zu ändern. Änderungen werden den Nutzern rechtzeitig mitgeteilt.</p>
    <p>Für Streitigkeiten, die aus der Nutzung unserer Website entstehen, gilt das Recht der Bundesrepublik Deutschland. Gerichtsstand ist Dortmund, NRW.</p>
    <p>Für rechtliche Fragen oder Anliegen bezüglich unserer Website, kontaktieren Sie uns bitte unter support@lethalgoose.com.</p>
  </v-container>
</template>
