<template>
  <v-card class="flex-fill" max-width="600">
    ...
    <v-card-subtitle>XP bis zum nächsten Level</v-card-subtitle>
    <v-card-text v-if="reqPalLevel">
      ...
      <v-progress-linear color="primary" min="0" :max="reqPalLevel.xp_threshold ? reqPalLevel.xp_threshold : 0"
